...
const Certificate_1 = __importDefault(__nccwpck_require__(866));
const Login_1 = __importDefault(__nccwpck_require__(235));
const run = async () => {
    const cert = new Certificate_1.default(core_1.getInput('certificate_path'), core_1.getInput('certificate_key'), core_1.getInput('certificate_iv'));
    const login = new Login_1.default(core_1.getInput('app_client_id'), core_1.getInput('username'), core_1.getInput('org_type'));
    core_1.info('*** Authentication started ***');
    // decrypt the certificate
    execSync_1.default(constants_1.Commands.OPEN_SSL, [
        'enc',
        '-nosalt',
        '-aes-256-cbc',
        '-d',
    ...
    core_1.info(`Connecting to: ${instanceurl}`);
    // login
    execSync_1.default(constants_1.Commands.SFDX, [
...
const constants_1 = __nccwpck_require__(122);
class Login {
    constructor(clientId, username, orgType) {
