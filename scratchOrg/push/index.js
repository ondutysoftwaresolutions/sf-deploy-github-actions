...
const run = async () => {
    ...
    if (parsedResult.status !== 0) {
        (0, core_1.setFailed)(`\u001b[38;2;255;0;0mERROR when pushing the changes: ${parsedResult.name} // ${parsedResult.message} // ${JSON.stringify(parsedResult.result)}`);
    }
    else {
        (0, core_1.info)(`\u001b[35m*** Changes were deployed successfully to the Scratch Org '${scratchOrgName}'. ***`);
    }
};
exports.pushToOrg = run;
run();
...
var _validate = _interopRequireDefault(__nccwpck_require__(783));
