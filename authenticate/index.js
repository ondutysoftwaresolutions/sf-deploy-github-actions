...
const run = async () => {
    const cert = new Certificate_1.default((0, core_1.getInput)('certificate_path'), (0, core_1.getInput)('certificate_key'), (0, core_1.getInput)('certificate_iv'));
    const login = new Login_1.default((0, core_1.getInput)('app_client_id'), (0, core_1.getInput)('username'), (0, core_1.getInput)('org_type'));
    (0, core_1.info)('*** Authentication started ***');
    // decrypt the certificate
    (0, execSync_1.default)(constants_1.Commands.OPEN_SSL, [
        'enc',
        '-nosalt',
        '-aes-256-cbc',
        '-d',
