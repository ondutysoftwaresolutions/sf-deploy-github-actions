...
const run = async () => {
    const configuration = new Download_1.default((0, core_1.getInput)('download_sfdx_url'), (0, core_1.getInput)('download_sfdx_filename'));
    (0, core_1.info)('*** Downloading and installing SFDX ***');
    // download
    (0, execSync_1.default)(constants_1.Commands.WGET, [`${configuration.sfdx_url}/${configuration.sfdx_filename}`]);
    (0, core_1.info)('*** SFDX Downloaded Successfully ***');
    // create the directory
    (0, execSync_1.default)(constants_1.Commands.MKDIR, [constants_1.DEFAULT_SFDX_CLI_INSTALLATION_FOLDER]);
    // decompress the file
    (0, execSync_1.default)(constants_1.Commands.TAR, [
        'xJf',
