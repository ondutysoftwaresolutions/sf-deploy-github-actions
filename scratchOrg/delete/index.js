...
const run = async () => {
    ...
    if (parsedResult.status !== 0) {
        (0, core_1.setFailed)(`\u001b[38;2;255;0;0mERROR when deleting the scratch org: ${parsedResult.name} // ${parsedResult.message}`);
    }
    else {
        (0, core_1.info)(`\u001b[35m*** Successful Deletion of the Scratch Org '${scratchOrgName}'. ***`);
    }
};
