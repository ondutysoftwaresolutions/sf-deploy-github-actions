...
const run = async () => {
    ...
    core_1.info('*** Deleting Scratch Org ***');
    // delete the org
    const result = execSync_1.default(constants_1.Commands.SFDX, [
        'force:org:delete',
        '--targetusername',
        scratchOrgName,
        '--noprompt',
    ...
    if (parsedResult.status !== 0) {
        core_1.setFailed(`\u001b[38;2;255;0;0mERROR when deleting the scratch org: ${parsedResult.name} // ${parsedResult.message}`);
    }
    else {
        core_1.info(`\u001b[35m*** Successful Deletion of the Scratch Org '${scratchOrgName}'. ***`);
    }
};
exports.deleteOrg = run;
run();
