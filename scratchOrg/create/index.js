...
const run = async () => {
    const scratchDefPath = (0, core_1.getInput)('scratch_definition_path');
    ...
    if (parsedResult.status !== 0) {
        (0, core_1.setFailed)(`\u001b[38;2;255;0;0mERROR when creating the scratch org: ${parsedResult.name} // ${parsedResult.message}`);
    }
    else {
        (0, core_1.info)(`\u001b[35m*** Successful Creation of the Scratch Org '${nameOrg}'. ***`);
        // set the ouput variable
        (0, core_1.setOutput)('scratch_org_name', nameOrg);
    }
};
exports.createOrg = run;
run();
