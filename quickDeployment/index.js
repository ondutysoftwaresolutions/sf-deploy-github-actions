...
const run = async () => {
    core_1.info('*** Deployment of the Package started ***');
    const result = execSync_1.default(constants_1.Commands.SFDX, [
        'force:source:deploy',
        '--targetusername',
        constants_1.DEFAULT_ALIAS_SF_INSTANCE,
        '--validateddeployrequestid',
        core_1.getInput('job_id'),
    ]);
    core_1.info(`\u001b[35m*** Deployment Result: ${result.toString()} ***`);
};
...
/******/ 	var __webpack_exports__ = __nccwpck_require__(37);
